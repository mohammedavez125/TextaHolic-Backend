...
// make connection with frontend
io.on("connection", async (socket) => {
  console.log('socket handshake query',JSON.stringify(socket.handshake));
  ...
  socket.on("accept_request", async (data) => {
    ...
    console.log("requesteed doc",request_doc);
  ...
  socket.on("get_direct_conversations", async ({ user_id }, callback) => {
    ...
    console.log(existing_conversations.length, "Existing Conversations");
